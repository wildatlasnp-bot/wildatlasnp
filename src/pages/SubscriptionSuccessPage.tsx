      ...
      >
        ...
        <div
          ...
          >
            ...
            {/* Back range (lightest, tallest peaks) */}
            <polygon points="0,200 0,185 25,170 60,145 90,160 120,135 150,148 180,120 210,140 240,128 270,150 300,138 335,155 360,142 360,200" fill="#1a3020" />

            {/* Mid range */}
            <polygon points="0,200 0,190 20,175 50,158 80,170 105,150 135,165 160,145 195,160 220,148 250,162 280,152 310,165 340,155 360,168 360,200" fill="#122318" />

            {/* Front range (darkest, most prominent) */}
            <polygon points="0,200 0,192 15,180 45,165 70,178 100,160 125,172 155,158 185,170 210,160 245,172 275,162 305,175 335,165 360,175 360,200" fill="#0e1a10" />
