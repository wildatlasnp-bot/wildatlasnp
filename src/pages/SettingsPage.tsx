...
const SettingsPage = ({ embedded }: { embedded?: boolean }) => {
  ...
  return (
    <div className={`bg-background max-w-lg mx-auto px-5 py-6 ${embedded ? 'pb-4 h-full overflow-y-auto' : 'min-h-screen pb-20'}`} {...(embedded ? { 'data-tab-scroll': '' } : {})}>
      ...
      {/* Profile */}
      <div style={{ marginTop: 24, borderTop: '1px solid #D4CFC9', paddingTop: 16 }} className="flex items-center justify-between mb-[14px]">
      ...
      <div style={{ borderTop: '1px solid #D4CFC9', marginTop: 24, paddingTop: 16 }}>
      ...
      <div className="pt-6 border-t border-border/60 mb-8">
        <p className="text-[10px] font-semibold tracking-widest uppercase text-muted-foreground" style={{ marginTop: 24, borderTop: '1px solid #D4CFC9', paddingTop: 16, marginBottom: 14 }}>Support</p>
        <div className="rounded-2xl overflow-hidden" style={{ backgroundColor: '#FFFFFF', boxShadow: '0 1px 3px rgba(0,0,0,0.07)' }}>
            <Link
              to="/privacy"
      ...
      <div className="border-t border-border/60">
        <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 10, fontWeight: 600, letterSpacing: '0.1em', textTransform: 'uppercase' as const, color: '#6B7280', marginTop: 24, borderTop: '1px solid #D4CFC9', paddingTop: 16, marginBottom: 14 }}>Account</p>
