...
const BG = "#F0EDEA";
const VIGNETTE = `radial-gradient(ellipse at center, transparent 60%, rgba(0,0,0,0.06) 100%)`;
const ICON_GLOW = "0 0 0 8px rgba(47,111,78,0.08), 0 0 0 16px rgba(47,111,78,0.04)";
...
const ResetPassword = () => {
  ...
  const backLink = (
    <span
      onClick={() => navigate("/")}
      style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 13, color: "#5C6B5E", cursor: "pointer" }}
    >
      ← Back to sign in
    </span>
  );
  ...
  if (isRecovery) {
    return (
      <div style={{ ...outerStyle, justifyContent: "space-between" }}>
        ...
        <div style={{ width: "100%", maxWidth: 320, margin: "0 auto", textAlign: "center", padding: "0 20px" }}>
          ...
          <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 15, color: "#5a5a4a", lineHeight: 1.6, margin: "0 0 28px" }}>
          ...
          <form onSubmit={handleReset} style={{ display: "flex", flexDirection: "column", gap: 10, textAlign: "left" }}>
            ...
            <button
              ...
              style={{
                ...
                backgroundColor: "#2F6F4E", color: "#FFFFFF",
                fontFamily: "'DM Sans', sans-serif", fontSize: 14, fontWeight: 600,
                letterSpacing: "0.04em", cursor: loading ? "not-allowed" : "pointer",
                opacity: loading ? 0.5 : 1, minHeight: 48, marginTop: 4, transition: "opacity 200ms",
              }}
            >
              Update Password
            </button>
          ...
          <div style={{ marginTop: 24, textAlign: "center" }}>{backLink}</div>
        </div>
  ...
  return (
    <div style={{ ...outerStyle, justifyContent: "center" }}>
      <div style={{ width: "100%", maxWidth: 320, margin: "0 auto", textAlign: "center", padding: "0 20px" }}>
        ...
        >
          <KeyRound size={36} color="#FFFFFF" strokeWidth={1.5} />
        </div>
        ...
        <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 15, color: "#5a5a4a", lineHeight: 1.6, margin: 0 }}>
          A reset link is on its way. You have 1 hour to use it.
        </p>
        ...
        >
          <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 13, fontWeight: 600, color: "#1A2F1E", margin: 0, marginBottom: 10 }}>
            Don't see it?
          </p>
          <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
            {["Check your spam or junk folder", "Make sure you entered the right email", "Allow a few minutes for delivery"].map((t) => (
              <p key={t} style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 13, color: "#5a5a4a", margin: 0, lineHeight: 1.4 }}>
        ...
        {/* Resend */}
        <div style={{ marginTop: 12, textAlign: "center", minHeight: 20 }}>
          {sent ? (
            <span style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 13, fontWeight: 500, color: "#2F6F4E" }}>Sent ✓</span>
          ) : showResendInput ? (
            <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
              <input
                type="email"
            ...
            <span style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 13, color: "#888878" }}>
              ...
              <button
                ...
                style={{
                  color: "#2F6F4E", textDecoration: "underline", textDecorationThickness: "1px",
                  textUnderlineOffset: "2px", background: "none", border: "none", padding: 0,
