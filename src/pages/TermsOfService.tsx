  ...
  <div className="min-h-screen bg-background max-w-lg mx-auto px-5 py-8 pb-20">
    ...
    <div className="space-y-5 text-sm text-muted-foreground leading-relaxed font-body">
      ...
      <section className="space-y-2">
        ...
        <p>WildAtlas also provides AI-powered trip planning recommendations through Poko, our in-app assistant. Poko responses are generated by artificial intelligence and should be treated as suggestions, not professional advice.</p>
      </section>
