  ...
  <div className="min-h-screen bg-background max-w-lg mx-auto px-5 py-8">
    ...
    <div className="space-y-5 text-sm text-muted-foreground leading-relaxed font-body">
      ...
      <section className="space-y-2">
        ...
        <p>Pathfinder Agent is a <strong className="text-foreground">planning and informational tool</strong> designed to help outdoor enthusiasts monitor Yosemite National Park permit availability. We aggregate publicly available data to provide a convenient tracking experience.</p>
      </section>

      <section className="space-y-2">
        <h2 className="text-base font-heading font-semibold text-foreground">2. No Guarantee of Permit Availability</h2>
        <p className="font-medium text-foreground">Pathfinder Agent does not guarantee permit availability.</p>
        ...
        <p>Pathfinder Agent is not affiliated with, endorsed by, or partnered with Recreation.gov, the National Park Service, or any government agency.</p>
      </section>

      <section className="space-y-2">
        <h2 className="text-base font-heading font-semibold text-foreground">3. User Responsibilities</h2>
        <p>By using Pathfinder Agent, you agree to:</p>
        <ul className="list-disc pl-5 space-y-1">
      ...
      <section className="space-y-2">
        ...
        <p>Pathfinder Agent is provided "as is" without warranties of any kind. We are not liable for missed permits, inaccurate data, service downtime, or any damages arising from your use of the app.</p>
      </section>
