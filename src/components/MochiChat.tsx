        ...
        <div className="flex-1 min-h-0 flex flex-col relative" style={{ background: 'var(--wa-surface-sand)' }}>
          ...
          <div style={{ position: 'relative', zIndex: 10, display: 'flex', flexDirection: 'column', height: '100%' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '12px 24px 0', flexShrink: 0 }}>
              ...
              <h1 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 56, fontWeight: 300, letterSpacing: '-0.02em', color: '#1A1A1A', lineHeight: 1.05, margin: 0, marginBottom: 24, borderBottom: 'none' }}>Poko</h1>
            </div>
