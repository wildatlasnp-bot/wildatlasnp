...
const DiscoverTips = forwardRef<HTMLDivElement, DiscoverProps>(({ parkId = "yosemite", onParkChange, onNavigateToSniper }, ref) => {
  ...
  return (
    <div ref={ref} className="flex flex-col h-full" style={{ overflowY: "auto", overflowX: "visible" }} data-tab-scroll>
      ...
      <div className="relative h-[230px] overflow-hidden" style={{ width: "100vw", marginLeft: "calc(-50vw + 50%)", borderRadius: 0 }}>
        <img
          src={hero.image}
          alt={hero.alt}
