...
const TodayInParkStrip = ({ parkId }: TodayInParkStripProps) => {
  ...
  return (
    <div className="rounded-xl bg-muted/30 border border-border/40 p-4">
      <p className="text-[12px] font-semibold uppercase tracking-[0.08em] text-muted-foreground mb-3 font-body">
        ...
        {signals.map((signal, i) => {
          ...
          return (
            ...
            >
              ...
              <p className="text-[12px] font-medium uppercase text-muted-foreground leading-tight font-body">
                {signal.label}
              </p>
              <p className="text-[16px] font-semibold text-foreground leading-tight font-body">
                {signal.value}
              </p>
            </div>
          );
