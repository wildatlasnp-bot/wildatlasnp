...
import { Zap, Bell, MapPin, Crown, Loader2, ExternalLink } from "lucide-react";
        ...
        <motion.div key="offer" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
          ...
          <div className="relative bg-primary px-6 pt-8 pb-10 text-center overflow-hidden">
            ...
            >
              ...
              <p className="text-sm text-primary-foreground/75 mt-1 font-medium">Unlimited watches · All parks · SMS alerts</p>
            </motion.div>
          </div>
          ...
          <div className="px-6 pb-4">
            <div className="bg-muted/60 rounded-xl p-4 text-center">
              ...
              <p className="text-[11px] text-muted-foreground mt-1">Cancel anytime from your account settings</p>
            </div>
          </div>
