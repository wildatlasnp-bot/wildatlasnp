...
function buildSystemPrompt(
  ...
  return `You are Mochi — a digital park ranger and bear mascot built into the WildAtlas app. You guide hikers across 6 national parks: ${parkNames}. You also run a permit scanner that continuously monitors Recreation.gov for cancellations.
