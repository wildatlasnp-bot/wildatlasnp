      ...
      <table role="presentation" width="560" cellpadding="0" cellspacing="0" style="max-width:560px;width:100%;">
        ...
        <tr><td style="background-color:#FFFFFF;padding:32px 28px;">
          ...
          <p style="font-size:14px;line-height:1.7;color:#6B7B6B;margin:0 0 24px;font-family:-apple-system,sans-serif;">
            Mochi is now actively scanning Recreation.gov for your <strong style="color:#2D3B2D;">${d.permitName}</strong> permit at <strong style="color:#2D3B2D;">${d.parkName}</strong>. The moment a cancellation appears, you'll get a text at <strong style="color:#2D3B2D;">${d.maskedPhone}</strong> with a direct booking link.
          </p>
