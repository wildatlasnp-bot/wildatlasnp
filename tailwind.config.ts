  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        status: {
          quiet: "hsl(var(--status-quiet))",
          "quiet-foreground": "hsl(var(--status-quiet-foreground))",
          building: "hsl(var(--status-building))",
          "building-foreground": "hsl(var(--status-building-foreground))",
          busy: "hsl(var(--status-busy))",
          "busy-foreground": "hsl(var(--status-busy-foreground))",
          peak: "hsl(var(--status-peak))",
          "peak-foreground": "hsl(var(--status-peak-foreground))",
